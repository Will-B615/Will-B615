...
.SYNOPSIS 
    ...
    This PowerShell script sets the maximum system event log file size to 32,768 KB by configuring the MaxSize registry value. 
...
# Set System Event Log maximum size 
